...
def get_total_cases(country):
	...
	mycursor = mydb.cursor()
	sql3="SELECT total_cases FROM world_data WHERE country_name = @country"
	total_cases=mycursor.execute(sql3)
	return total_cases
...
def get_total_deaths(country):
	...
	mycursor = mydb.cursor()
	sql3="SELECT total_deaths FROM world_data WHERE country_name=@country"
	total_cases=mycursor.execute(sql3)
	return total_cases
...
def get_total_recovered(country):
	...
	mycursor = mydb.cursor()
	sql3="SELECT total_recovered FROM world_data WHERE country_name=@country"
	total_cases=mycursor.execute(sql3)
	return total_cases
...
def get_active_cases(country):
	...
	mycursor = mydb.cursor()
	sql3="SELECT active_cases FROM world_data WHERE country_name=@country"
	total_cases=mycursor.execute(sql3)
	return total_cases